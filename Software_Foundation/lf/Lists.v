...
Lemma eqn_reflx : forall n : nat, eqb n n = true.
Proof.
  intros. induction n.
  - simpl. reflexivity.
...
Proof.
  intros. simpl. 
  rewrite eqn_reflx. rewrite add_comm. rewrite <- plus_1_l.
  reflexivity.
Qed.
...
Proof.
  intros. destruct x as [x']. simpl. rewrite eqb_refl. reflexivity.
Qed.
(** [] *)
